  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-background">
      <div className="mx-auto flex h-14 max-w-4xl items-center justify-between px-4">
        <Button type="button" variant="ghost" onClick={onCancel} disabled={isSaving} data-test-id="cancel-brief-button">
          Cancel
        </Button>
        <h1 className="text-lg font-semibold">Create Brief</h1>
        <Button type="submit" disabled={!canSave || isSaving} data-test-id="save-brief-button">
