...
Jesteś doświadczonym architektem oprogramowania, którego zadaniem jest utworzenie diagramu Mermaid w celu wizualizacji architektury stron Next.js 15 (App Router) i komponentów React dla modułu logowania i rejestracji. Diagram powinien zostać utworzony w następującym pliku: ui.md
...
2. Uwzględnij następujące elementy w swoim diagramie:
   ...
   - Next.js Layouts, Server Components, Client Components i aktualizacje istniejących komponentów
