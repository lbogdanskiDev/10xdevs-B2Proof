...
Components are available in the `src/components/ui` folder, according to the aliases in the `components.json` file.
...
This project uses the "new-york" style variant with "neutral" as the base color and CSS variables for theming, as configured in the `components.json` file.
